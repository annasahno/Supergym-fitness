...
/* harmony import */ var _utils_remove_no_js_class_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/remove-no-js-class.js */ "./js/utils/remove-no-js-class.js");
...
/* harmony import */ var _modules_video_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/video.js */ "./js/modules/video.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_utils_remove_no_js_class_js__WEBPACK_IMPORTED_MODULE_1__["removeNoJsClass"])();
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_video_js__WEBPACK_IMPORTED_MODULE_3__["findVideos"])();
    Object(_modules_tabs_js__WEBPACK_IMPORTED_MODULE_4__["toggleTabs"])();
  });
});
...
document.querySelectorAll('.swiper-slide').forEach(function (slide) {
  return slide.setAttribute('tabindex', 0);
});
...
var swiperReview = new Swiper('.review__swiper', {
  keyboard: {
    enabled: true,
    onlyInViewport: false
  },
...
var buttonTabs = document.querySelectorAll('[data-tab]');
var contentTabs = document.querySelectorAll('[data-content]');
...
var setAttribute = function setAttribute(buttonTab, contentTab) {
  buttonTab.setAttribute(['data-tab-active'], '');
  contentTab.setAttribute(['data-tab-content-active'], '');
};
var deleteAttribute = function deleteAttribute() {
  for (var i = 0; i < buttonTabs.length; i++) {
...
function setupVideo(video) {
  var linkElement = video.querySelector('.video__link');
  var buttonElement = video.querySelector('.video__button');
